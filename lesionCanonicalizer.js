...
(function initLesionCanonicalizer(global) {
  ...
  function applyDirectSynonyms(value) {
    ...
    const direct = [
      ...
      [/^pelvis$/, 'bilateral pelvic bones'],
      [/^bilateral pelvis$/, 'bilateral pelvic bones'],
      [/^pelvic bones$/, 'bilateral pelvic bones'],
      [/^left pelvis$/, 'left pelvic bones'],
      [/^right pelvis$/, 'right pelvic bones'],
